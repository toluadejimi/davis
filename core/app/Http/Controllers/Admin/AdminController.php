...
class AdminController extends Controller
{
    ...
    {   
        ...
        $widget['total_wallet_amount'] = UserWallet::totalWalletBalance();
        ...
        $deposit['total_deposit_amount']        = WalletHistory::where('transaction_type', 1)
        ->where('status', Status::PAYMENT_SUCCESS)->sum('amount') 
        + 
        Deposit::where('status', Status::PAYMENT_SUCCESS)->sum("amount");
